 ...
 */
@TestPropertySource(locations = "classpath:application.mini.properties")
public class BaseSolrControllerTest {
  @Autowired
  ...
  protected static String readJson(String expectedJson) throws IOException {
    ClassLoader classLoader = BaseSolrControllerTest.class.getClassLoader();
