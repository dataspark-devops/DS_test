...
YAML=$BASEDIR/conf/ds_transform_enrich_postpaid_user_profile.yaml

#--------------------------------------------------------------------------------------------------
# ----The default paths points to local file system. Comment this section if reading from HDFS ----
#--------------------------------------------------------------------------------------------------
EDW_POSTPAID_PATH=$BASEDIR/data/postpaid.csv
FIXED_CELL_MASTER_PATH=$BASEDIR/data/fixed_cell_master.txt
HOME_WORK_INFO_PATH=$BASEDIR/data/home_work_postpaid.txt
...
#--------------------------------------------------------------------------------------------------
#EDW_POSTPAID_PATH=webhdfs://10.44.59.42:50070/data/edw/postpaid/LA_MEDW_RPT_PO_ACTIVE_BASE_201704_Encrypted.csv
...
#OUTPUT_PATH=/user/dsuser/telco_planning/output_skylab/singtel/may/enriched_profile/postpaid
...
-edw_postpaid ${EDW_POSTPAID_PATH} \
